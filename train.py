...
def setup_training_loop_kwargs(
    ...
    args.training_set_kwargs = dnnlib.EasyDict(class_name='training.data.dataset.GarmentDataset', img_path=img_data, use_labels=True, max_size=None, xflip=False)
    ...
    if cfg == 'auto':
        ...
        spec.lrate = 0.001 if res >= 1024 else 0.0001  # edit lr here (deafult:spec.lrate = 0.001 if res >= 1024 else 0.001)
        # spec.lrate = 0.0001  # resume learning rate
...
@click.option('--resume_kimg', help='Resume training from what kimg [default: noresume]', type=int, metavar='INT')
